...
import 'package:todo_app/app/home/job_entries/entry_list_item.dart';
import 'package:todo_app/app/home/job_entries/entry_page.dart';
import 'package:todo_app/app/home/jobs/edit_job_page.dart';
...
import 'package:todo_app/common_widgets/platform_exception_alert_dialog.dart';
            ...
            appBar: AppBar(
              ...
              actions: <Widget>[
                IconButton(
                  ...
                  onPressed: () =>
                      EditJobPage.show(context, database, job: job),
                ),
                IconButton(
                  icon: Icon(Icons.add),
